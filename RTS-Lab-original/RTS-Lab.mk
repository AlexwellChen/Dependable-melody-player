...
$(IntermediateDirectory)/Watchdog.c$(ObjectSuffix): Watchdog.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/Watchdog.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Watchdog.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_tim.c$(ObjectSuffix): driver/src/stm32f4xx_tim.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_tim.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_tim.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/canTinyTimber.c$(ObjectSuffix): canTinyTimber.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/canTinyTimber.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/canTinyTimber.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/dispatch.s$(ObjectSuffix): dispatch.s
	...
	$(AS) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/dispatch.s" $(ASFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/dispatch.s$(ObjectSuffix) -I$(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_dac.c$(ObjectSuffix): driver/src/stm32f4xx_dac.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_dac.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_dac.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/TinyTimber.c$(ObjectSuffix): TinyTimber.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/TinyTimber.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/TinyTimber.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Committee.c$(ObjectSuffix): Committee.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/Committee.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Committee.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/sciTinyTimber.c$(ObjectSuffix): sciTinyTimber.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/sciTinyTimber.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/sciTinyTimber.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_usart.c$(ObjectSuffix): driver/src/stm32f4xx_usart.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_usart.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_usart.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/sioTinyTimber.c$(ObjectSuffix): sioTinyTimber.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/sioTinyTimber.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/sioTinyTimber.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_rcc.c$(ObjectSuffix): driver/src/stm32f4xx_rcc.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_rcc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_rcc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_can.c$(ObjectSuffix): driver/src/stm32f4xx_can.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_can.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_can.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_exti.c$(ObjectSuffix): driver/src/stm32f4xx_exti.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_exti.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_exti.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_gpio.c$(ObjectSuffix): driver/src/stm32f4xx_gpio.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_gpio.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_gpio.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/driver_src_stm32f4xx_syscfg.c$(ObjectSuffix): driver/src/stm32f4xx_syscfg.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/driver/src/stm32f4xx_syscfg.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/driver_src_stm32f4xx_syscfg.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/application.c$(ObjectSuffix): application.c
	...
	$(CC) $(SourceSwitch) "E:/OPENME/EDA423/EDA423/RTS-Lab-original/application.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/application.c$(ObjectSuffix) $(IncludePath)
